    		...
    		<td style="padding:0;">
    			<table border="0" cellspacing="2" celllpaddding="2">
    				<tr>
    					...
    					<td><input  fw-filter="isFill" fw-label="<?php echo $sPrefix?>start_date" type="text" value="<?php echo $sDate; ?>" class="fix" id="<?php echo $sPrefix?>start_date" name="start_date" readonly="true" /></td>
    					...
    					<td>
                            <select id="<?php echo $sPrefix?>start_time" name="start_time"  class="select_option">
                                <?php for($i = 1 ; $i <= 24 ; $i++){?>
    	...
    	<tr>
    		...
    		<td>
    			<table border="0" cellspacing="2" celllpaddding="2">
    				<tr>
    					<td><span class="neccesary">*</span><label for="scheduler_date">Date:</label></td>
    					<td><input type="text" fw-filter="isFill" fw-label="<?php echo $sPrefix?>end_date" id="<?php echo $sPrefix?>end_date" name="end_date" value="<?php echo $sDate; ?>" class="fix"  readonly="true" /></td>
    					...
    					<td>
                            <select id="<?php echo $sPrefix?>end_time" name="end_time" class="select_option">
                                <?php for($i = 1 ; $i <= 24 ; $i++){?>
                                    <option value="<?php echo $i;?>"><?php echo str_pad($i,2,'0',STR_PAD_LEFT);?>:00</option>
                                <?php }?>
                            </select>
